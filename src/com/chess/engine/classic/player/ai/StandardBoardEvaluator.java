...
public final class StandardBoardEvaluator implements BoardEvaluator {
    ...
    //             + kingThreats(board.whitePlayer(), depth) + "\n" + "White attacks : " + attacks(board.whitePlayer())
    //             + "\n" + "White castle : " + castle(board.whitePlayer()) + "\n" + "White pieceEval : "
    //             + pieceEvaluations(board.whitePlayer()) + "\n" + "White pawnStructure : "
    //             + pawnStructure(board.whitePlayer()) + "\n" + "---------------------\n" + "Black Mobility : "
    //             + mobility(board.blackPlayer()) + "\n" + "Black kingThreats : "
    //             + kingThreats(board.blackPlayer(), depth) + "\n" + "Black attacks : " + attacks(board.blackPlayer())
    //             + "\n" + "Black castle : " + castle(board.blackPlayer()) + "\n" + "Black pieceEval : "
    //             + pieceEvaluations(board.blackPlayer()) + "\n" + "Black pawnStructure : "
    //             + pawnStructure(board.blackPlayer()) + "\n\n" + "Final Score = " + evaluate(board, depth);
    // }
